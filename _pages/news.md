...
- One paper accepted to AAAI 2021. [arxiv](https://arxiv.org/pdf/2006.08661.pdf) [code](https://github.com/sustainlab-group/mapillarygcn) [PDF](https://www.aaai.org/AAAI21Papers/AAAI-10056.LeeJ.pdf)

- One paper accepted to AAAI 2021. [arxiv](https://arxiv.org/pdf/2006.04224.pdf) [PDF](https://www.aaai.org/AAAI21Papers/AAAI-10300.AyushK.pdf)

## 2020

- Joined Samsung Research America as a Senior Research Scientist.

- One paper accepted to CVPR 2020 Workshop on Agriculture-Vision. [arxiv](https://arxiv.org/pdf/2004.05471.pdf) [code](https://github.com/sustainlab-group/ParcelDelineation) [PDF](https://openaccess.thecvf.com/content_CVPRW_2020/papers/w5/Aung_Farm_Parcel_Delineation_Using_Spatio-Temporal_Convolutional_Networks_CVPRW_2020_paper.pdf)

- One paper accepted to IJCAI 2020. [arxiv](https://arxiv.org/pdf/2002.01612.pdf) [PDF](https://www.ijcai.org/Proceedings/2020/0608.pdf)

- Presentation at Qualcomm HQ in San Diego. [PDF](../files/Qualcomm.pdf)

- One paper accepted to CVPR 2020 (Oral). [arxiv](https://arxiv.org/pdf/2003.00425.pdf) [code](https://github.com/ermongroup/PatchDrop) [video](https://www.youtube.com/watch?v=n0HGh2x6Cgg) [PDF](https://openaccess.thecvf.com/content_CVPR_2020/papers/Uzkent_Learning_When_and_Where_to_Zoom_With_Deep_Reinforcement_Learning_CVPR_2020_paper.pdf)

- Presentation at Planet Labs HQ in San Francisco. [PDF](../files/Planet_Presentation.pdf)

- Seminar presentation at Sabanci University, Turkey. [Abstract](https://mfg.sabanciuniv.edu/tr/events-detail/21371) [PDF](../files/Sabanci_Seminar.pdf)

- One paper accepted to WACV 2020. [arxiv](https://arxiv.org/pdf/1912.06838.pdf) [code](https://github.com/VSAnimator/stgan) [PDF](https://openaccess.thecvf.com/content_WACV_2020/papers/Sarukkai_Cloud_Removal_from_Satellite_Images_using_Spatiotemporal_Generator_Networks_WACV_2020_paper.pdf)

- One paper accepted to WACV 2020. [arxiv](https://arxiv.org/pdf/1912.03966.pdf) [code](https://github.com/uzkent/EfficientObjectDetection) [Short Presentation](../files/WACV_Short.pdf)
...
- One paper accepted to KDD 2019. [arxiv](https://arxiv.org/pdf/1905.01627.pdf) [code](https://github.com/uzkent/WikipediaPovertyMapping) [PDF](https://dl.acm.org/doi/10.1145/3292500.3330784)

- Presentation at Orbital Insight. [PDF](../files/Orbital_Insight_Presentation.pdf)

- One paper accepted to IEEE Transactions on Geoscience and Remote Sensing. [arxiv](https://arxiv.org/abs/1711.07235) [code](https://github.com/uzkent/HKCF_Tracker)

## 2018

- Seminar presentation at Carnegie Mellon University VASC. [Abstract](https://www.ri.cmu.edu/event/object-detection-and-tracking-on-low-resolution-aerial-images/) [PDF](../files/CMU_VSAR_Seminar.pdf)

- One paper accepted to WACV 2018. [arxiv](https://arxiv.org/pdf/1801.06729.pdf) [code](https://github.com/uzkent/EnKCF_Tracker) [Presentation](../files/WACV18_Presentation.pdf) [Poster](../files/WACV18_Poster.pdf) [Demo Video 1](https://www.youtube.com/embed/dWeIbECiVkY?ecver=1) [Demo Video 2](https://www.youtube.com/embed/ZCnAjxJkseY?ecver=1) [Demo Video 3](https://www.youtube.com/embed/hAxA903YH2Y?ecver=1) [Demo Video 4](https://www.youtube.com/embed/h-yXx1A2dL0?ecver=1)

## 2017

- One paper accepted to CVPR 2017 Workshop on Perception Beyond the Visible Spectrum.

- Released Hyperspectral Aerial Video Dataset for vehicle tracking. [Dataset](https://uzkent.github.io/datasets/) [Code](https://github.com/uzkent/CVPRW17_Paper_Code)

## 2016

- Defended Ph.D. thesis on "Aerial Vehicle Tracking using a Multi-modal Optical Sensor". [Presentation](../files/Thesis.Defense.pdf)

- Completed internship at Huawei R&D.

- One paper accepted to IEEE Journal of Selected Topics in Remote Sensing and Observation. [Video](https://www.youtube.com/watch?v=scRQjEMGSRE)

## 2014

- One paper presented at IEEE Western New York Image Processing Workshop. [Code](https://github.com/uzkent/3D_MRI_Segmentation)
